...
var Base = (function (Component$$1) {
  ...
  Base.prototype.render = function render$$1 () {
    return preact.h( 'div', { class: "main" },
      preact.h( 'div', { class: "head" },
        preact.h( 'div', { class: "head-container" },
          preact.h( 'div', { class: "logo" }, "ECHO", preact.h( 'br', null ), "SOAR")
        ),
        preact.h( 'nav', null,
          preact.h( 'div', { class: "nav-container" },
            preact.h( Router, { class: 'nav-active', displayAll: true },
              preact.h( 'a', { class: "nav-item nav-active", href: "#/", path: "/" }, "Blog"),
              preact.h( 'a', { class: "nav-item", path: "#/about", path: "/about" }, "About")
            )
          )
        )
      ),
...
render(preact.h( IWenKu, null ), document.body);
